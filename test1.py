...
import json,csv
import random,time
def parseData(weightState,consignId):
    ...
    if weightState == '0':
        ...
        print('开始一次过磅重量：',zl)
        url2 = 'http://10.12.200.18:8080/a/weight/weight/saveweightConsign?id={}&zl={}'.format(consignId,zl)
        ...
        print('开始二次过磅重量：',zl)
        url2 = 'http://10.12.200.18:8080/a/weight/weight/updateweightConsign?id={}&zl={}'.format(consignId,zl)
        ret = requests.get(url2)
        print(ret.text)
...
def parseCsv(filePath):
    ...
    for line in lines:
        ...
        parseData(weightState,consignId)
        time.sleep(1)
